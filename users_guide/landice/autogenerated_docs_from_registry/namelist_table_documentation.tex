...
\input{landice/section_descriptions/velocity_solver.tex}
\vspace{0.5in}
{\small
\begin{center}
...
\input{landice/section_descriptions/advection.tex}
\vspace{0.5in}
{\small
\begin{center}
\begin{longtable}{| p{2.0in} || p{4.0in} |}
...
\input{landice/section_descriptions/calving.tex}
\vspace{0.5in}
{\small
\begin{center}
\begin{longtable}{| p{2.0in} || p{4.0in} |}
...
\input{landice/section_descriptions/thermal_solver.tex}
\vspace{0.5in}
{\small
\begin{center}
\begin{longtable}{| p{2.0in} || p{4.0in} |}
...
\input{landice/section_descriptions/physical_parameters.tex}
\vspace{0.5in}
{\small
\begin{center}
\begin{longtable}{| p{2.0in} || p{4.0in} |}
...
\input{landice/section_descriptions/subglacial_hydro.tex}
\vspace{0.5in}
{\small
\begin{center}
\begin{longtable}{| p{2.0in} || p{4.0in} |}
...
\input{landice/section_descriptions/AM_globalStats.tex}
\vspace{0.5in}
{\small
\begin{center}
\begin{longtable}{| p{2.0in} || p{4.0in} |}
...
\input{landice/section_descriptions/AM_regionalStats.tex}
\vspace{0.5in}
{\small
\begin{center}
\begin{longtable}{| p{2.0in} || p{4.0in} |}
