...
\end{longtable}
\end{center}
\subsection[zTop]{\hyperref[sec:var_tab_state]{zTop}}
...
\end{longtable}
\end{center}
\subsection[avgVelocityZonal]{\hyperref[sec:var_tab_state]{avgVelocityZonal}}
...
\end{longtable}
\end{center}
\subsection[varVelocityZonal]{\hyperref[sec:var_tab_state]{varVelocityZonal}}
