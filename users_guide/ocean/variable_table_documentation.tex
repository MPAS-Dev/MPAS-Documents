...
\begin{longtable}{| p{2.0in} | p{4.0in} |}
	...
	\hline
	\hyperref[subsec:var_sec_state_zTop]{zTop} & z-coordinate of the top of the layer \\
	\hline
	...
	\hline
	\hyperref[subsec:var_sec_state_avgVelocityZonal]{avgVelocityZonal} & time-averaged velocity in the eastward direction \\
	\hline
	\hyperref[subsec:var_sec_state_avgVelocityMeridional]{avgVelocityMeridional} & time-averaged velocity in the northward direction \\
	\hline
	\hyperref[subsec:var_sec_state_varVelocityZonal]{varVelocityZonal} & variance of velocity in the eastward direction \\
	\hline
	\hyperref[subsec:var_sec_state_varVelocityMeridional]{varVelocityMeridional} & variance of velocity in the northward direction \\
	\hline
...
\begin{longtable}{| p{2.0in} | p{4.0in} |}
	...
	\hline
	\hyperref[subsec:var_sec_tend_tend_tracer1]{tend\_tracer1} & test tracer \\
	\hline
