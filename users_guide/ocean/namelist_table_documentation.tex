...
\begin{longtable}{| p{2.0in} || p{4.0in} |}
	...
	\hline
	\hyperref[subsec:nm_sec_config_use_coupled_forcing]{config\_use\_coupled\_forcing} & Logical flag that determines if forcing from a coupler should be used. \\
	\hline
	\hyperref[subsec:nm_sec_config_flux_attenuation_coefficient]{config\_flux\_attenuation\_coefficient} &  Coefficient used to determine transmission of surface fluxes. Fluxes are defined with  $e^{z/\gamma}$  where this coefficient is  $\gamma$ . \\
	\hline
