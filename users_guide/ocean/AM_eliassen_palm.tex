...
Calculations are performed in buoyancy coordinates by interpolating the state to \verb+nBuoyancyLayers+ buoyancy layers uniformly distributed between \verb+rhomin+ and \verb+rhomax+. 
